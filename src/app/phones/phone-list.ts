...
export const PHONES: PhoneClass[] = [
  ...
  { id: 8, model: '2 XL', name: 'Pixel', cost: '', screen: '', repair: '', image: '/assets/pixel-2-XL.jpg' },
  { id: 11, model: 'S8 Plus', name: 'Samsung', cost: '', screen: '', repair: '', image: 'assets/samsung-galaxy-s8-plus.jpg' },
  { id: 9, model: 'U11', name: 'HTC', cost: '', screen: '', repair: '', image: '/assets/htc-u11.jpg' },
